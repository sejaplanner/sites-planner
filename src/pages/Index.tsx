      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-8 md:py-16 relative z-10">
          ...
          <div className="text-center mb-12 md:mb-20">
            ...
            <div className="relative max-w-6xl mx-auto">
              <div className="space-y-6 md:space-y-8">
                <h1 className="text-3xl md:text-6xl lg:text-7xl font-light text-gray-900 leading-[1.1] tracking-tight">
                  Vamos criar o{' '}
                  <span className="relative inline-block">
                    ...
                    <div className="absolute -bottom-1 md:-bottom-2 left-0 w-full h-0.5 md:h-1 bg-gradient-to-r from-indigo-300 to-purple-300 rounded-full opacity-60"></div>
                  </span>
                </h1>
                
                <h2 className="text-3xl md:text-6xl lg:text-7xl font-extralight text-gray-800 leading-[1.1] tracking-tight">
                  perfeito para sua{' '}
              ...
              {/* Floating Elements */}
              <div className="absolute -top-4 md:-top-8 -right-4 md:-right-8 w-16 md:w-20 h-16 md:h-20 bg-gradient-to-br from-purple-200/40 to-blue-200/40 rounded-full blur-xl animate-pulse"></div>
              <div className="absolute -bottom-6 md:-bottom-12 -left-6 md:-left-12 w-24 md:w-32 h-24 md:h-32 bg-gradient-to-br from-indigo-200/30 to-purple-200/30 rounded-full blur-2xl"></div>
            </div>
            
            {/* Subtitle with Modern Typography */}
            <div className="mt-12 md:mt-16 max-w-5xl mx-auto text-center px-4">
              ...
              <div className="mt-8 md:mt-12 flex justify-center">
                <div className="w-24 md:w-32 h-px bg-gradient-to-r from-transparent via-gray-300 to-transparent"></div>
              </div>
            </div>
          </div>
          ...
          <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16 px-4">
            <Card className="p-8 md:p-10 lg:p-14 bg-white/90 backdrop-blur-md border-0 shadow-[0_8px_32px_rgba(0,0,0,0.08)] hover:shadow-[0_16px_48px_rgba(0,0,0,0.12)] transition-all duration-500 relative overflow-hidden">
              {/* Card Background Pattern */}
              <div className="absolute inset-0 bg-gradient-to-br from-white via-gray-50/50 to-purple-50/30 pointer-events-none"></div>
              <div className="absolute top-0 right-0 w-24 md:w-32 h-24 md:h-32 bg-gradient-to-bl from-blue-50 to-transparent rounded-full opacity-60"></div>
              
              <div className="relative z-10">
                <div className="mb-6 md:mb-8">
                  <div className="inline-flex items-center justify-center w-16 md:w-18 h-16 md:h-18 bg-gradient-to-br from-purple-500 to-blue-500 rounded-2xl mb-6 md:mb-8 shadow-lg">
                    <MessageSquare className="w-8 md:w-10 h-8 md:h-10 text-white" />
                  </div>
                </div>
                
                <h3 className="text-2xl md:text-3xl lg:text-4xl font-light text-gray-900 mb-4 md:mb-6 tracking-tight">
                  Pronto para <span className="font-medium">começar</span>?
                </h3>
                
                <p className="text-base md:text-lg lg:text-xl text-gray-600 mb-8 md:mb-10 leading-relaxed font-light max-w-2xl mx-auto">
          ...
          <div className="hidden md:grid md:grid-cols-3 gap-6 lg:gap-8 mb-12 md:mb-16 max-w-7xl mx-auto px-4">
            <Card className="p-6 md:p-8 bg-white/60 backdrop-blur-sm border-0 shadow-[0_4px_24px_rgba(0,0,0,0.06)] hover:shadow-[0_8px_32px_rgba(0,0,0,0.1)] transition-all duration-300 group">
              <div className="w-12 md:w-14 h-12 md:h-14 bg-gradient-to-br from-purple-100 to-purple-200 rounded-2xl flex items-center justify-center mb-4 md:mb-6 group-hover:scale-105 transition-transform">
                <MessageSquare className="w-6 md:w-7 h-6 md:h-7 text-purple-600" />
              </div>
              <h3 className="text-lg md:text-xl font-medium text-gray-900 mb-3 md:mb-4 tracking-tight">Conversa Inteligente</h3>
            ...
            <Card className="p-6 md:p-8 bg-white/60 backdrop-blur-sm border-0 shadow-[0_4px_24px_rgba(0,0,0,0.06)] hover:shadow-[0_8px_32px_rgba(0,0,0,0.1)] transition-all duration-300 group">
              <div className="w-12 md:w-14 h-12 md:h-14 bg-gradient-to-br from-blue-100 to-blue-200 rounded-2xl flex items-center justify-center mb-4 md:mb-6 group-hover:scale-105 transition-transform">
                <Sparkles className="w-6 md:w-7 h-6 md:h-7 text-blue-600" />
              </div>
              <h3 className="text-lg md:text-xl font-medium text-gray-900 mb-3 md:mb-4 tracking-tight">Processo Otimizado</h3>
              <p className="text-sm md:text-base text-gray-600 leading-relaxed font-light">
            ...
            <Card className="p-6 md:p-8 bg-white/60 backdrop-blur-sm border-0 shadow-[0_4px_24px_rgba(0,0,0,0.06)] hover:shadow-[0_8px_32px_rgba(0,0,0,0.1)] transition-all duration-300 group">
              <div className="w-12 md:w-14 h-12 md:h-14 bg-gradient-to-br from-green-100 to-emerald-200 rounded-2xl flex items-center justify-center mb-4 md:mb-6 group-hover:scale-105 transition-transform">
                <CheckCircle2 className="w-6 md:w-7 h-6 md:h-7 text-green-600" />
              </div>
              <h3 className="text-lg md:text-xl font-medium text-gray-900 mb-3 md:mb-4 tracking-tight">Dados Seguros</h3>
              <p className="text-sm md:text-base text-gray-600 leading-relaxed font-light">
          ...
          {/* Mobile Carousel */}
          <div className="mb-8 md:mb-12 px-4 md:hidden">
            <MobileCarousel />
          </div>

          {/* Footer */}
          <div className="text-center mt-16 md:mt-20 text-gray-500 px-4">
            <p className="text-xs md:text-sm lg:text-base mb-4 font-light">© 2024 Planner - Criamos experiências digitais excepcionais</p>
            <PrivacyPolicyModal>
